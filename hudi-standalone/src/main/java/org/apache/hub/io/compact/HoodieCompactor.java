...
public interface HoodieCompactor extends Serializable {
   ...
   */
  HoodieCompactionPlan generateCompactionPlan(Configuration conf, HoodieTable hoodieTable, HoodieWriteConfig config,
      String compactionCommitTime, Set<HoodieFileGroupId> fgIdsInPendingCompactions) throws IOException;

  /**
   * Execute compaction operations and report back status.
   */
  List<WriteStatus> compact(Configuration conf, HoodieCompactionPlan compactionPlan, HoodieTable hoodieTable,
