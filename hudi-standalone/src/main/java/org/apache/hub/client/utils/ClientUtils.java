...
package org.apache.hub.client.utils;
...
public class ClientUtils {
   ...
   */
  public static HoodieTableMetaClient createMetaClient(Configuration conf, HoodieWriteConfig config,
                                                       boolean loadActiveTimelineOnLoad) {
    return new HoodieTableMetaClient(conf, config.getBasePath(), loadActiveTimelineOnLoad,
