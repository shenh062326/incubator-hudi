...
public class HoodieCompactionConfig extends DefaultHoodieConfig {
  ...
  // By default, treat any file <= 16MB as a small file.
  public static final String DEFAULT_PARQUET_SMALL_FILE_LIMIT_BYTES = String.valueOf(16777216);
  /**
